...
(async () => {
    ...
    await page.goto('https://www.cyber.nj.gov/threat-center/public-data-breaches/', { waitUntil: 'networkidle0' });
    
    const featuredPost = await page.waitForSelector('.featuredPostBlock .articleFeature');
